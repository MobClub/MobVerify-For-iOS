...
- (void)setUp {
    ...
    _viewController =(ViewController *) window.rootViewController;
}
...
- (void)testCodeVerify
{
    ...
    //@"86"
    [MobVerify verifyWithCode:@"363212" phoneNumber:@"18588558175" zone:@"86" result:^(NSError *error) {
...
- (void)testCodeVerifyNoBlock
{
    ...
    [MobVerify verifyWithCode:@"346611" phoneNumber:@"18588558175" zone:@"86" result:nil];
...
- (void)testLoginRootVC
{
    XCTestExpectation *expectation = [self expectationWithDescription:@"testLoginNoRootVC"];

        MobVerifyConfig *config = [[MobVerifyConfig alloc] init];
        config.rootViewController = _viewController;
